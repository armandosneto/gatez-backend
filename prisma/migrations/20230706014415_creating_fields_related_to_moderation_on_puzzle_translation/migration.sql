...
CREATE TABLE "new_puzzle_translations" (
    ...
    "discarted" BOOLEAN NOT NULL DEFAULT false,
    "reviewerId" TEXT,
...
INSERT INTO "new_puzzle_translations" ("approved", "createdAt", "description", "id", "locale", "puzzleId", "title", "userId") SELECT "approved", "createdAt", "description", "id", "locale", "puzzleId", "title", "userId" FROM "puzzle_translations";
