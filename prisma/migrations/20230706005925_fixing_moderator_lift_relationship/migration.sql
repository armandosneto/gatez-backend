...
INSERT INTO "new_user_bans" ("createdAt", "expiresAt", "id", "lifted", "liftedAt", "moderatorId", "moderatorLiftId", "reason", "reasonLifted", "userId") SELECT "createdAt", "expiresAt", "id", "lifted", "liftedAt", "moderatorId", "moderatorLiftId", "reason", "reasonLifted", "userId" FROM "user_bans";
